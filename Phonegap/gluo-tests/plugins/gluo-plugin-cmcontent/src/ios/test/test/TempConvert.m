...
-(NSString*)toString:(BOOL)addNameWrap {
    ...
    if (addNameWrap == YES)
        [nsString appendString:@"<TempConvert>" ];
    [nsString appendFormat:@"<SoapVersion>%@</SoapVersion>" , [TempConvert_Enums SoapProtocolVersionToString:[self soapVersion]]];
...
-(void)FahrenheitToCelsius:(NSString *)fahrenheit {
    ...
    [params appendString:@"<FahrenheitToCelsius xmlns=\"http://www.w3schools.com/webservices/\">"];
    [params appendFormat:@"<Fahrenheit>%@</Fahrenheit>" , fahrenheit];
    [params appendString:@"</FahrenheitToCelsius>"];
    ...
    [onwreq addValue:@"http://www.w3schools.com/webservices/FahrenheitToCelsius" forHTTPHeaderField:@"SOAPAction"];
    ...
    [self setEventName:@"http://www.w3schools.com/webservices/FahrenheitToCelsiusDidFinish"];
}
...
-(void)CelsiusToFahrenheit:(NSString *)celsius {
    NSMutableString *params = [NSMutableString string];
    [params appendString:@"<?xml version=\"1.0\" encoding=\"utf-8\"?><soap:Envelope xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\" xmlns:xsd=\"http://www.w3.org/2001/XMLSchema\" xmlns:soap=\"http://schemas.xmlsoap.org/soap/envelope/\"><soap:Body>"];
    [params appendString:@"<CelsiusToFahrenheit xmlns=\"http://www.w3schools.com/webservices/\">"];
    [params appendFormat:@"<Celsius>%@</Celsius>" , celsius];
    [params appendString:@"</CelsiusToFahrenheit>"];
    [params appendString:@"</soap:Body></soap:Envelope>"];
    NSURL *onwURL = [[NSURL alloc] initWithString:[self url]];
    NSMutableURLRequest *onwreq = [NSMutableURLRequest requestWithURL:onwURL cachePolicy:NSURLRequestReloadIgnoringLocalAndRemoteCacheData timeoutInterval:30.0];
    NSString *messageLen = [NSString stringWithFormat:@"%d", [params length]];
    [onwreq addValue:[onwURL host] forHTTPHeaderField:@"Host"];
    [onwreq addValue:@"http://www.w3schools.com/webservices/CelsiusToFahrenheit" forHTTPHeaderField:@"SOAPAction"];
    [onwreq addValue:@"text/xml; charset=utf-8" forHTTPHeaderField:@"Content-Type"];
    [onwreq addValue:messageLen forHTTPHeaderField:@"Content-Length"];
    [onwreq setHTTPMethod:@"POST"];
    [onwreq setHTTPBody:[params dataUsingEncoding:NSUTF8StringEncoding]];
    ...
    self.wsConnection = [[NSURLConnection alloc] initWithRequest:onwreq delegate:self];
    [self setEventName:@"http://www.w3schools.com/webservices/CelsiusToFahrenheitDidFinish"];
}
...
-(id)copyWithZone:(NSZone *)zone {
    TempConvert *finalCopy = [[[self class] allocWithZone: zone] init];
