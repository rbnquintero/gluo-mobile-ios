...
-(NSString*)toString:(BOOL)addNameWrap {
    ...
    if (addNameWrap == YES)
        [nsString appendString:@"<LocalTime>" ];
    [nsString appendFormat:@"<SoapVersion>%@</SoapVersion>" , [LocalTime_Enums SoapProtocolVersionToString:[self soapVersion]]];
...
-(void)LocalTimeByZipCode:(NSString *)zipCode {
    ...
    [params appendString:@"<LocalTimeByZipCode xmlns=\"http://www.ripedev.com/\">"];
    [params appendFormat:@"<ZipCode>%@</ZipCode>" , zipCode];
    [params appendString:@"</LocalTimeByZipCode>"];
    ...
    [onwreq addValue:@"http://www.ripedev.com/LocalTimeByZipCode" forHTTPHeaderField:@"SOAPAction"];
    ...
    [self setEventName:@"http://www.ripedev.com/LocalTimeByZipCodeDidFinish"];
}
...
-(id)copyWithZone:(NSZone *)zone {
    LocalTime *finalCopy = [[[self class] allocWithZone: zone] init];
